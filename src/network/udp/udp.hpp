/**
 * @file
 * @brief Header file for UDP
 *
 * This file defines the UDP datagram format. In addition to the 16-bit source
 * and destination protocol port numbers, the UDP header contains a 16-bit
 * datagram length field and a 16-bit checksum.
 *
 * This file also contains symbolic constants for values assigned to the most
 * commonly used UDP protocol port numbers.
 *
